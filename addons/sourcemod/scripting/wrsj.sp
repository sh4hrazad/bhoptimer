...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	CreateNative("WRSJ_Fork_GetSjInfo", Native_Fork_GetSjInfo);
...
bool RetrieveWRSJ(int client, char[] mapname, DataPack MOREPACKS=null)
{
	...
	LogMessage("WRSJ: requesting: %s", apiurl);
...
public any Native_Fork_GetSjInfo(Handle plugin, int numParams)
{
	ArrayList records;
	...
	SetNativeArray(1, info, sizeof(WRSJ_RecordInfo));
