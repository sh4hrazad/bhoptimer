...
char sqlite_playertimes_create[] = 
"CREATE TABLE IF NOT EXISTS `playertimes` "...
	"("...
...
char sqlite_wrs_min_create[] = 
"CREATE VIEW IF NOT EXISTS `wrs_min` "...
	"AS SELECT "...
	"MIN(time) time, "...
	"map, "...
	"track, "...
...
char sqlite_wrs_create[] = 
"CREATE VIEW IF NOT EXISTS `wrs` "...
	"AS SELECT "...
	"a.* "...
	"FROM `playertimes` a "...
	"JOIN `wrs_min` b "...
...
"INSERT INTO `playertimes` "...
	"(auth, map, time, jumps, date, style, strafes, sync, points, track, exact_time_int, prestrafe) VALUES "...
