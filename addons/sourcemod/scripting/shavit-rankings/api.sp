...
void CreateNatives()
{
	...
	CreateNative("Shavit_CanAutoBhopInTrack", Native_CanAutoBhopInTrack);
...
public int Native_CanAutoBhopInTrack(Handle handler, int numParams)
{
	return view_as<bool>(!(gI_AllowBhop & (1 << Shavit_GetClientTrack(GetNativeCell(1)))));
}
